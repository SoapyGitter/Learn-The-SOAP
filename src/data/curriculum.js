        ...
        challenges: [
          {
            ...
            language: 'javascript',
            title: 'Hello World',
            prompt: 'Write a function `greet(name)` that returns the string `"Hello, <name>!"`. Then call it with `"World"` and print the result.',
...
console.log(greet("World"));`,
            ...
            testCases: [
              ...
              { call: 'greet("Claude")',    expected: 'Hello, Claude!' },
              { call: 'greet("Student")',   expected: 'Hello, Student!' },
              { call: 'greet("JavaScript")',expected: 'Hello, JavaScript!' },
              { call: 'greet("React")',     expected: 'Hello, React!' },
              { call: 'greet("Dev")',       expected: 'Hello, Dev!' },
              { call: 'greet("LMS")',       expected: 'Hello, LMS!' },
              { call: 'greet("User")',      expected: 'Hello, User!' },
              { call: 'greet("Earth")',     expected: 'Hello, Earth!' },
            ],
            difficulty: 'easy',
...
console.log(sumArray([1, 2, 3, 4, 5]));`,
            ...
            examples: [
              ...
              { input: 'sumArray([10, -3, 7])',      output: '14' },
              { input: 'sumArray([])',               output: '0' },
            ],
            testCases: [
              { call: 'sumArray([1,2,3,4,5])',  expected: '15' },
              { call: 'sumArray([10,-3,7])',     expected: '14' },
              { call: 'sumArray([])',            expected: '0' },
              { call: 'sumArray([0])',           expected: '0' },
              { call: 'sumArray([100])',         expected: '100' },
              { call: 'sumArray([-1,-2,-3])',    expected: '-6' },
              { call: 'sumArray([2,2,2,2,2])',   expected: '10' },
              { call: 'sumArray([1,2,3])',        expected: '6' },
              { call: 'sumArray([5,5,5,5])',      expected: '20' },
              { call: 'sumArray([0,0,0,1])',      expected: '1' },
              { call: 'sumArray([7,-7])',         expected: '0' },
            ],
            difficulty: 'easy',
            tags: ['arrays', 'loops'],
          },
          {
            ...
            language: 'javascript',
            title: 'FizzBuzz',
            prompt: 'Write a function `fizzbuzz(n)` that returns `"Fizz"` for multiples of 3, `"Buzz"` for multiples of 5, `"FizzBuzz"` for multiples of both, or the number as a string otherwise. Then print results for 1–15.',
            hint: 'Check divisibility by 15 first (both conditions), then 3, then 5.',
...
for (let i = 1; i <= 15; i++) {
  console.log(fizzbuzz(i));
            ...
            expectedOutput: '1\n2\nFizz\n4\nBuzz\nFizz\n7\n8\nFizz\nBuzz\n11\nFizz\n13\n14\nFizzBuzz',
            examples: [
              { input: 'fizzbuzz(3)',  output: 'Fizz',     note: 'divisible by 3' },
              { input: 'fizzbuzz(5)',  output: 'Buzz',     note: 'divisible by 5' },
              { input: 'fizzbuzz(15)', output: 'FizzBuzz', note: 'divisible by both' },
            ],
            testCases: [
              { call: 'fizzbuzz(1)',  expected: '1' },
              { call: 'fizzbuzz(2)',  expected: '2' },
              { call: 'fizzbuzz(3)',  expected: 'Fizz' },
              { call: 'fizzbuzz(4)',  expected: '4' },
              { call: 'fizzbuzz(5)',  expected: 'Buzz' },
              { call: 'fizzbuzz(6)',  expected: 'Fizz' },
...
console.log(counter());`,
            expectedOutput: '1\n2\n3',
            examples: [
              { input: 'const c = makeCounter(); c()', output: '1', note: 'first call returns 1' },
              { input: 'c(); c()',                     output: '2 then 3', note: 'each call increments' },
              { input: 'makeCounter() is independent', output: 'new counter starts at 1', note: 'each makeCounter() is isolated' },
            ],
            testCases: [
              { call: '(() => { const c = makeCounter(); return c(); })()',               expected: '1' },
              { call: '(() => { const c = makeCounter(); c(); return c(); })()',          expected: '2' },
              { call: '(() => { const c = makeCounter(); c(); c(); return c(); })()',     expected: '3' },
              { call: '(() => { const c = makeCounter(); c(); c(); c(); return c(); })()',expected: '4' },
              { call: '(() => { const c = makeCounter(); for(let i=0;i<9;i++) c(); return c(); })()', expected: '10' },
              { call: '(() => { const a = makeCounter(); const b = makeCounter(); a(); return b(); })()', expected: '1' },
              { call: '(() => { const a = makeCounter(); a(); a(); const b = makeCounter(); return b(); })()', expected: '1' },
              { call: '(() => { const c = makeCounter(); return typeof c(); })()',        expected: 'number' },
              { call: '(() => { const c = makeCounter(); c(); c(); c(); c(); c(); return c(); })()', expected: '6' },
              { call: '(() => { const c = makeCounter(); return c() + c() + c(); })()',  expected: '6' },
            ],
            difficulty: 'medium',
...
console.log(JSON.stringify(flattenArray([[1,2],[3,[4,5]],[6]])));`,
            ...
            examples: [
              ...
              { input: 'flattenArray([[1,2],[3,[4,5]],[6]])', output: '[1,2,3,[4,5],6]', note: 'only one level deep' },
              { input: 'flattenArray([[1],[2],[3]])',        output: '[1,2,3]' },
            ],
            testCases: [
              { call: 'JSON.stringify(flattenArray([[1,2],[3,4]]))',             expected: '[1,2,3,4]' },
              { call: 'JSON.stringify(flattenArray([[1,2],[3,[4,5]],[6]]))',     expected: '[1,2,3,[4,5],6]' },
              { call: 'JSON.stringify(flattenArray([[1],[2],[3]]))',              expected: '[1,2,3]' },
              { call: 'JSON.stringify(flattenArray([]))',                        expected: '[]' },
              { call: 'JSON.stringify(flattenArray([[1]]))',                     expected: '[1]' },
              { call: 'JSON.stringify(flattenArray([[1,2,3]]))',                  expected: '[1,2,3]' },
              { call: 'flattenArray([[1,2],[3,4]]).length',                     expected: '4' },
              { call: 'JSON.stringify(flattenArray([[0],[false],[null]]))',       expected: '[0,false,null]' },
              { call: 'JSON.stringify(flattenArray([["a","b"],["c"]]))',          expected: '["a","b","c"]' },
              { call: 'JSON.stringify(flattenArray([[1,2],[],[3]]))',             expected: '[1,2,3]' },
              { call: 'Array.isArray(flattenArray([[1],[2]]))',                  expected: 'true' },
            ],
            difficulty: 'medium',
            tags: ['arrays'],
          },
...
setTimeout(() => {
  if (callCount === 0) console.log("called"); // fires once
            ...
            examples: [
              { input: 'debounce(fn, 300) — called 3×', output: 'fn runs once after 300ms', note: 'rapid calls collapse into one' },
              { input: 'debounce(fn, 0) — called then waited', output: 'fn runs once after the timeout', note: '0ms still defers to next tick' },
              { input: 'debounce returns a function', output: 'typeof debounce(fn, 0) === "function"', note: 'always returns a wrapper function' },
            ],
            testCases: [
              { call: 'typeof debounce(() => {}, 100)',                              expected: 'function' },
              { call: '(() => { const db = debounce(() => {}, 0); return typeof db; })()', expected: 'function' },
              { call: '(() => { let n = 0; const db = debounce(() => n++, 9999); db(); db(); db(); return n; })()', expected: '0' },
              { call: '(() => { const db = debounce(x => x * 2, 0); return typeof db; })()', expected: 'function' },
              { call: '(() => { let calls = 0; const db = debounce(() => calls++, 5000); db(); db(); db(); db(); db(); return calls; })()', expected: '0' },
              { call: '(() => { const db = debounce(() => {}, 100); return db.length; })()', expected: '0' },
              { call: '(() => { let t; const db = debounce(() => {}, 0); db(); db(); return "no throw"; })()', expected: 'no throw' },
              { call: '(() => { const dbs = [debounce(() => {}, 0), debounce(() => {}, 0)]; return dbs.length; })()', expected: '2' },
              { call: '(() => { let n = 0; const db = debounce(() => { n = 42; }, 5000); db(); return n; })()', expected: '0' },
              { call: '(() => { const fn = debounce(() => {}, 50); fn(); fn(); return "ok"; })()', expected: 'ok' },
            ],
            difficulty: 'hard',
...
console.log(binarySearch([1, 3, 5, 7, 9, 11], 7));`,
            expectedOutput: '3',
            examples: [
              { input: 'binarySearch([1,3,5,7,9,11], 7)', output: '3',  note: 'found at index 3' },
              { input: 'binarySearch([1,3,5,7,9,11], 4)', output: '-1', note: '4 is not in the array' },
              { input: 'binarySearch([2,4,6,8,10], 2)',   output: '0',  note: 'first element' },
            ],
            testCases: [
              { call: 'binarySearch([1,3,5,7,9,11], 7)',   expected: '3' },
              { call: 'binarySearch([1,3,5,7,9,11], 4)',   expected: '-1' },
              { call: 'binarySearch([2,4,6,8,10], 2)',     expected: '0' },
              { call: 'binarySearch([2,4,6,8,10], 10)',    expected: '4' },
              { call: 'binarySearch([2,4,6,8,10], 6)',     expected: '2' },
              { call: 'binarySearch([1], 1)',              expected: '0' },
              { call: 'binarySearch([1], 2)',              expected: '-1' },
              { call: 'binarySearch([], 5)',               expected: '-1' },
              { call: 'binarySearch([1,2,3,4,5], 5)',      expected: '4' },
              { call: 'binarySearch([1,2,3,4,5], 1)',      expected: '0' },
              { call: 'binarySearch([10,20,30,40,50], 35)',expected: '-1' },
            ],
            difficulty: 'easy',
          ...
          },
          {
            ...
            language: 'javascript',
            title: 'Bubble Sort',
            prompt: 'Implement `bubbleSort(arr)` that sorts an array in ascending order in-place and returns it. Print the sorted `[64, 34, 25, 12, 22, 11, 90]`.',
...
console.log(bubbleSort([64, 34, 25, 12, 22, 11, 90]).join(','));`,
            ...
            examples: [
              ...
              { input: 'bubbleSort([3,1,2])',                 output: '[1,2,3]' },
              { input: 'bubbleSort([1])',                     output: '[1]', note: 'single element unchanged' },
            ],
            testCases: [
              { call: 'bubbleSort([64,34,25,12,22,11,90]).join(",")', expected: '11,12,22,25,34,64,90' },
              { call: 'bubbleSort([3,1,2]).join(",")',                 expected: '1,2,3' },
              { call: 'bubbleSort([1]).join(",")',                     expected: '1' },
              { call: 'bubbleSort([]).join(",")',                      expected: '' },
              { call: 'bubbleSort([5,4,3,2,1]).join(",")',            expected: '1,2,3,4,5' },
              { call: 'bubbleSort([1,2,3,4,5]).join(",")',            expected: '1,2,3,4,5' },
              { call: 'bubbleSort([2,1]).join(",")',                   expected: '1,2' },
              { call: 'bubbleSort([10,9,8,7]).join(",")',             expected: '7,8,9,10' },
              { call: 'bubbleSort([3,3,1,2]).join(",")',              expected: '1,2,3,3' },
              { call: 'bubbleSort([0,-1,1]).join(",")',               expected: '-1,0,1' },
              { call: 'Array.isArray(bubbleSort([2,1]))',             expected: 'true' },
            ],
            difficulty: 'easy',
            tags: ['sorting'],
          },
          {
            ...
            language: 'javascript',
            title: 'Two Sum',
            prompt: 'Given an array of integers `nums` and a target, return the indices of the two numbers that add up to target. Print the answer for `nums=[2,7,11,15], target=9`.',
...
console.log(twoSum([2, 7, 11, 15], 9).join(','));`,
            expectedOutput: '0,1',
            examples: [
              { input: 'twoSum([2,7,11,15], 9)',  output: '[0,1]', note: 'nums[0]+nums[1]=9' },
              { input: 'twoSum([3,2,4], 6)',       output: '[1,2]', note: 'nums[1]+nums[2]=6' },
              { input: 'twoSum([3,3], 6)',         output: '[0,1]' },
            ],
            testCases: [
              { call: 'twoSum([2,7,11,15], 9).join(",")',   expected: '0,1' },
              { call: 'twoSum([3,2,4], 6).join(",")',       expected: '1,2' },
              { call: 'twoSum([3,3], 6).join(",")',         expected: '0,1' },
              { call: 'twoSum([1,2,3,4], 7).join(",")',     expected: '2,3' },
              { call: 'twoSum([0,4,3,0], 0).join(",")',     expected: '0,3' },
              { call: 'twoSum([-1,-2,-3,-4,-5], -8).join(",")', expected: '2,4' },
              { call: 'twoSum([1,5,3,7], 8).join(",")',     expected: '1,3' },
              { call: 'twoSum([2,5,5,11], 10).join(",")',   expected: '1,2' },
              { call: 'Array.isArray(twoSum([1,2], 3))',    expected: 'true' },
              { call: 'twoSum([1,2], 3).length',            expected: '2' },
              { call: 'twoSum([4,1,2,7,11,15], 9).join(",")', expected: '1,3' },
            ],
            difficulty: 'easy',
...
console.log(fib(10));`,
            expectedOutput: '55',
            examples: [
              { input: 'fib(0)', output: '0',  note: 'base case' },
              { input: 'fib(1)', output: '1',  note: 'base case' },
            ...
            testCases: [
              ...
              { call: 'fib(3)',  expected: '2' },
              { call: 'fib(4)',  expected: '3' },
              { call: 'fib(5)',  expected: '5' },
              { call: 'fib(6)',  expected: '8' },
              { call: 'fib(7)',  expected: '13' },
              { call: 'fib(8)',  expected: '21' },
              { call: 'fib(10)', expected: '55' },
              { call: 'fib(15)', expected: '610' },
            ],
            difficulty: 'easy',
...
console.log(coinChange([1, 5, 6, 9], 11));`,
            expectedOutput: '2',
            examples: [
              { input: 'coinChange([1,5,6,9], 11)', output: '2', note: '9+2×1 is not optimal; 6+5=2 coins' },
              { input: 'coinChange([1,2,5], 11)',   output: '3', note: '5+5+1' },
              { input: 'coinChange([2], 3)',         output: '-1', note: 'impossible' },
            ],
            testCases: [
              { call: 'coinChange([1,5,6,9], 11)',  expected: '2' },
              { call: 'coinChange([1,2,5], 11)',    expected: '3' },
              { call: 'coinChange([2], 3)',         expected: '-1' },
              { call: 'coinChange([1], 0)',         expected: '0' },
              { call: 'coinChange([1], 5)',         expected: '5' },
              { call: 'coinChange([5,10,25], 30)',  expected: '2' },
              { call: 'coinChange([1,5,10,25], 41)',expected: '4' },
              { call: 'coinChange([2], 4)',         expected: '2' },
              { call: 'coinChange([1,2,5], 0)',     expected: '0' },
              { call: 'coinChange([3,5], 8)',       expected: '2' },
              { call: 'coinChange([1,4,5], 8)',     expected: '2' },
            ],
            difficulty: 'medium',
...
console.log(lcs("abcde", "ace"));`,
            expectedOutput: '3',
            examples: [
              { input: 'lcs("abcde", "ace")',  output: '3', note: '"ace" is a common subsequence' },
              { input: 'lcs("abc", "abc")',    output: '3', note: 'identical strings' },
              { input: 'lcs("abc", "def")',    output: '0', note: 'no common characters' },
            ],
            testCases: [
              ...
              { call: 'lcs("abc", "")',         expected: '0' },
              { call: 'lcs("a", "a")',          expected: '1' },
              { call: 'lcs("a", "b")',          expected: '0' },
              { call: 'lcs("abcbdab", "bdcab")',expected: '4' },
              { call: 'lcs("AGGTAB", "GXTXAYB")',expected: '4' },
              { call: 'lcs("bl", "yby")',       expected: '1' },
              { call: 'lcs("oxcpqrsvwf", "shmtulqrypy")', expected: '2' },
            ],
            difficulty: 'medium',
